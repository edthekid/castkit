...
const DESC = '無料のルーレット抽選ツール。ルーレット・スロットの2モード搭載。名前を入力してランダム抽選。登録不要、ブラウザだけで使える。配信・対戦ゲームの司会進行に。 / Free random picker with Wheel and Slot modes. No sign-up required.';
