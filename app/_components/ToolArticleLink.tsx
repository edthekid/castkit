...
import { getArticleByToolHref } from '../_lib/articles';
...
export function ToolArticleLink() {
  ...
  const article = getArticleByToolHref(pathname);
  ...
  return (
    <Link
      href={article.href}
      className="ck-card ck-card-interactive group flex items-center gap-3 p-4 mt-12"
    >
