...
export const translations = {
  ja: {
    ...
    'timer.pomo.every':     '長い休憩の間隔(回)',
    'timer.pomo.completed': '完了サイクル: {n}',
    'timer.pomo.settings':  '設定',
    'timer.pomo.howtoTitle': '使い方',
    'timer.pomo.about':      'ポモドーロは、短い「作業」と「休憩」を自動でくり返して、集中と休息のリズムを作るタイマーです。作業を4回終えるごとに「長い休憩」が入り、完了した作業サイクル数も確認できます。',
    'timer.pomo.step1':      '作業と休憩の分数を設定します（長い休憩は作業4回ごとに自動で入ります）。',
    'timer.pomo.step2':      '「開始」を押すと、作業タイマーがスタートします。',
    'timer.pomo.step3':      '時間になると作業→休憩→作業…と自動で切り替わり、切替時に通知音（オン時）と画面の点滅でお知らせします。',
    'timer.pomo.step4':      '「スキップ」で次のフェーズへ、「リセット」で最初に戻せます。設定はブラウザに自動保存されます。',
    'timer.soundOn':  '通知音オン',
  ...
  en: {
    ...
    'timer.font.sans':      'Default',
    'timer.font.mono':      'Mono',
    'timer.font.serif':     'Serif',
    ...
    'timer.pomo.about':      'Pomodoro is a timer that automatically alternates short "focus" and "break" periods to build a rhythm of concentration and rest. After every 4 focus sessions a "long break" kicks in, and you can track how many focus cycles you have completed.',
    'timer.pomo.step1':      'Set the minutes for focus and break (a long break is added automatically every 4 focus sessions).',
    'timer.pomo.step2':      'Press "Start" to begin the focus timer.',
    'timer.pomo.step3':      'When time is up it switches focus → break → focus automatically, alerting you with a sound (when on) and a flashing screen.',
    'timer.pomo.step4':      'Use "Skip" to jump to the next phase and "Reset" to start over. Your settings are saved automatically in the browser.',
