...
export const translations = {
  ja: {
    ...
    'timer.pomo.step1':      '作業・休憩・長い休憩の分数と、「長い休憩までの作業回数」を設定します。',
  ...
  en: {
    ...
    'timer.pomo.every':     'Sessions until long break',
    ...
    'timer.pomo.step1':      'Set the minutes for focus, break, and long break, plus how many focus sessions come before a long break.',
