...
export const translations = {
  ja: {
    ...
    'home.dice.description': '3D物理演算で転がるサイコロ。TRPG（d4〜d100）・ドット目・履歴コピー対応。',
    'home.cardOpen': '開く',
    ...
    'dice.chinchiro.legendNormal':  '○の目（2つ同じ＋1つ）',
    'dice.chinchiro.legendHifumi':  'ヒフミ（1・2・3）',
    'dice.chinchiro.legendMenashi': '目なし',
    'dice.chinchiro.multiplierPip': '×目の数',
  ...
  en: {
    ...
    'home.dice.description': '3D dice with real physics. TRPG dice (d4–d100), classic pips, copyable history.',
    'home.cardOpen': 'Open',
    ...
    'dice.canvasLabel':  '3D dice display area',
