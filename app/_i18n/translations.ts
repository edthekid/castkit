...
export const translations = {
  ja: {
    ...
    'home.dice.description': '3D物理演算で転がるサイコロ。TRPG（d4〜d100）・色変更・履歴コピー対応。',
    'home.cardOpen': '開く',
    ...
    'dice.total':      '合計',
    'dice.color':      'ダイスの色',
    'dice.colorPresets': 'プリセット',
    'dice.customColor':  '自由な色を選ぶ',
    'dice.colorCode':    'カラーコード（#RRGGBB）',
    'dice.trpgPreset':   'ダイスセット',
    'dice.trpgHint':     'TRPGでよく使うダイスをワンタップで構成',
    'dice.d100':         'd100（百分率）',
    'dice.d100Note':     '十の位・一の位のダイスで00〜99を判定します',
    'dice.history':      '履歴',
  ...
  en: {
    ...
    'home.dice.description': '3D dice with real physics. TRPG dice (d4–d100), custom colors, copyable history.',
    'home.cardOpen': 'Open',
    ...
    'dice.colorPresets': 'Presets',
    'dice.customColor':  'Pick a custom color',
    'dice.colorCode':    'Color code (#RRGGBB)',
    'dice.trpgPreset':   'Dice set',
    'dice.trpgHint':     'Configure common TRPG dice with one tap',
    'dice.d100':         'd100 (percentile)',
    'dice.d100Note':     'Rolls 00–99 using a tens die and a ones die',
