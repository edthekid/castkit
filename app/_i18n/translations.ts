...
export const translations = {
  ja: {
    ...
    'timer.pomo.step1':      '作業・休憩・長い休憩の分数と、長い休憩を入れる間隔（作業◯回ごと）を設定します。',
  ...
  en: {
    ...
    'timer.pomo.step1':      'Set the minutes for focus, break, and long break, plus how often a long break occurs (every N focus sessions).',
